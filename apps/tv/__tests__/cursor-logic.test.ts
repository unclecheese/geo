import { cursorReduce, clickReduce, nudgeCursor } from "../src/input/cursor-logic";
...
test("nudgeCursor moves one fixed step per direction (up decreases y) and clamps", () => {
  expect(nudgeCursor({ x: 960, y: 540 }, "up", 40, B)).toEqual({ x: 960, y: 500 });
  expect(nudgeCursor({ x: 960, y: 540 }, "down", 40, B)).toEqual({ x: 960, y: 580 });
  expect(nudgeCursor({ x: 960, y: 540 }, "left", 40, B)).toEqual({ x: 920, y: 540 });
  expect(nudgeCursor({ x: 960, y: 540 }, "right", 40, B)).toEqual({ x: 1000, y: 540 });
  // clamps at the edges, never off-screen
  expect(nudgeCursor({ x: 10, y: 10 }, "left", 40, B)).toEqual({ x: 0, y: 10 });
  expect(nudgeCursor({ x: 1900, y: 1070 }, "down", 40, B)).toEqual({ x: 1900, y: 1080 });
});
